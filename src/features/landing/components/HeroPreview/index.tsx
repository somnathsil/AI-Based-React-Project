    ...
    <div className="hero-preview">
      <div className="hero-preview__card">
        <div className="hero-preview__top-bar">
          <span className="hero-preview__badge">✨ AI ICON SEARCH</span>
        </div>

        <div className="hero-preview__input-area">
          <div className="hero-preview__input-label">Search for an icon</div>
        ...
        <div className="hero-preview__result">
          ...
          <div className="hero-preview__result-label">Settings (from Lucide)</div>
        </div>
